...
BEGIN_MESSAGE_MAP(CImageToolDoc, CDocument)
	...
	ON_COMMAND(ID_FILTER_CLOSING, &CImageToolDoc::OnFilterClosing)
	ON_COMMAND(ID_FILTER_OPENING, &CImageToolDoc::OnFilterOpening)
...
void CImageToolDoc::OnFilterMax()
{
	...
	IppFilterMaximum(imgSrc, imgDst);
...
void CImageToolDoc::OnFilterMin()
{
	...
	IppFilterMinimum(imgSrc, imgDst);
...
void CImageToolDoc::OnFilterClosing()
{
	IppByteImage imgSrc;
	IppByteImage imgDst;
	...
	IppFilterClosing(imgSrc, imgDst);
...
void CImageToolDoc::OnFilterOpening()
{
	IppByteImage imgSrc;
	IppByteImage imgDst;
	...
	IppFilterOpening(imgSrc, imgDst);
